...
import { oneOnOneFAQ } from '../data/faq'
    ...
    <>
          ...
          <div className="grid lg:grid-cols-3 gap-12 items-center">
            <div className="lg:col-span-2">
              <ScrollReveal>
                <span className="inline-block px-4 py-1.5 bg-gold-400/20 text-gold-400 text-sm font-semibold rounded-full mb-6">
                  PREMIUM \u2022 BESPOKE TRANSFORMATION
                </span>
                <h1 className="font-display text-4xl md:text-5xl font-bold text-white mb-4">
                  One-on-One <span className="text-gold-gradient">Leadership Coaching</span>
                </h1>
                <p className="text-xl text-slate-300 mb-6">Deep, Bespoke Transformation for CXOs & Senior Leaders with Complex Challenges</p>
                <ul className="space-y-3 mb-8">
                  {['16 personalized sessions over 4 months', 'Physiology, emotions, purpose, spiritual alignment', 'WhatsApp access between sessions', 'Multi-modal approach customized to YOU', 'Optional Tiruvannamalai retreat'].map((item, i) => (
                ...
                <div className="flex flex-wrap gap-4">
                  <Button to="/contact">Request Intake Call</Button>
                  <Button href="#journey" variant="secondary">See Full Program</Button>
                </div>
              </ScrollReveal>
            </div>
            ...
            <ScrollReveal delay={0.2}>
              <div className="bg-navy-800 rounded-2xl p-8 border-2 border-gold-400 shadow-lg shadow-gold-400/10">
                <div className="text-3xl font-bold text-gold-400 font-display mb-1">{'\u20B9'}8L + GST</div>
                <p className="text-slate-300 mb-2">4 months \u2022 16 sessions \u2022 Flexible scheduling</p>
                <p className="text-gold-400/80 text-sm mb-6">Limited to 6 clients at a time</p>
                <Button to="/contact" className="w-full">Request Intake Call</Button>
              </div>
            </ScrollReveal>
          </div>
        </div>
      ...
      <section className="py-24 bg-navy-900">
        <div className="max-w-5xl mx-auto px-6">
          <SectionHeading title="Who Is This Premium Program For?" subtitle="Bespoke, intensive work for senior leaders with complex, multi-layered challenges who need maximum depth and personalization." light />
      ...
      <section id="journey" className="py-24 bg-navy-950">
        <div className="max-w-6xl mx-auto px-6">
          <SectionHeading title="The 16-Session Journey" subtitle="Four months of deep, personalized transformation across physiology, emotions, purpose, and spiritual layers." light />
          ...
          <ScrollReveal className="mt-8 text-center">
            <p className="text-slate-300/70 text-sm italic">
              This is a framework, not a rigid structure. Your specific challenges determine the actual flow. Sessions are 60-120 minutes each.
            </p>
          </ScrollReveal>
        </div>
      </section>
      ...
      <section className="py-24 bg-navy-900">
        <div className="max-w-6xl mx-auto px-6">
          <SectionHeading title="Multi-Modal Methodology" subtitle="I customize the modality mix to what serves YOUR transformation. Not everyone needs every modality." light />

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {modalities.map(({ icon: Icon, title, text, items }, i) => (
              <ScrollReveal key={i} delay={i * 0.08}>
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <ScrollReveal>
            <div className="bg-navy-900 rounded-2xl p-8 md:p-10 border-2 border-gold-400/20 mb-8">
              <h3 className="font-display text-xl font-bold text-white mb-6">Complete Premium Package</h3>
          ...
          <ScrollReveal delay={0.1}>
            <div className="bg-navy-900 rounded-2xl p-8 border-2 border-gold-400">
              <h3 className="font-display text-xl font-bold text-white mb-3">Investment: {'\u20B9'}8 Lakh + GST</h3>
              <p className="text-slate-300 text-sm leading-relaxed mb-2">
                Premium, bespoke work with maximum customization and depth. Limited to 6 active clients at any time.
              </p>
              <p className="text-slate-300 text-sm">
                <strong className="text-white">Payment Options:</strong> Full upfront or 2 installments (50% at start, 50% at Session 8)
              </p>
            </div>
          </ScrollReveal>
          ...
          <ScrollReveal delay={0.2} className="mt-6">
            <div className="bg-navy-900/50 rounded-2xl p-6 border border-gold-400/20">
              <p className="text-slate-300 text-sm leading-relaxed">
                <strong className="text-white">Important:</strong> While this coaching can be therapeutic, it is not a replacement for therapy or psychiatric treatment. If you are working with a mental health professional and they are comfortable with you engaging in coaching, I am happy to consult with them.
              </p>
            </div>
          </ScrollReveal>
        </div>
      ...
      <section className="py-24 bg-navy-950">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <FAQAccordion items={oneOnOneFAQ} dark />
        </div>
      </section>
