...
const defaults = {
  hero: {
    badge: 'Leadership Coaching in India for CXOs, Founders & Senior Leaders',
    headline: "What If Pressure Made You Stronger?",
    headlineGold: '',
  ...
  testimonials: {
    title: 'Results From Leadership Coaching',
    subtitle: "Hear from senior leaders, CXOs and founders who made shifts in their leadership through coaching with Gowtham Balaji.",
  },
  stats: {
    items: [
...
export default function Home() {
  ...
  return (
    <>
      <Helmet>
        <title>Best Leadership Coach in India | Gowtham Balaji | The Leadership Tattva</title>
        <meta name="description" content="Looking for a Best leadership coach in India? Gowtham Balaji offers integration coaching for senior leaders, CXOs & founders. Book your free discovery call today." />
