          ...
          <div className="space-y-6">
            {depths.map((d, i) => (
              <ScrollReveal key={i} delay={i * 0.08}>
                <div className="bg-white border border-navy-950/10 border-l-[3px] border-l-navy-950 p-9 md:p-11 transition-all duration-300 hover:border-l-gold-400 hover:shadow-[0_12px_40px_rgba(9,1,52,0.06)]">
